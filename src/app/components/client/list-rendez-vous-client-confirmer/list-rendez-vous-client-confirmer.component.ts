...
@Component({
  selector: 'app-list-rendez-vous-client-confirmer',
  imports: [CommonModule, FormsModule],
  templateUrl: './list-rendez-vous-client-confirmer.component.html',
  styleUrl: './list-rendez-vous-client-confirmer.component.css'
})
export class ListRendezVousClientConfirmerComponent {
    ...
    //implements OnInit
      ...
      ngOnInit() {
        ...
        this.getRendezVousClientConfirmerDefault();
      }

      getRendezVousClientConfirmerDefault(): void {
        console.log("tonga atoooooo");
        this.rendezVousService.getRendezVousClientConfirmerDefault().subscribe((data: any) => {
      ...
      getAllRendezVousClientConfirmerSearch(): void {
        ...
        this.rendezVousService.getAllRendezVousClientConfirmerSearch(dateDebut, dateFin)
          .subscribe((data: any) => {
